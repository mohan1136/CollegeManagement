...
<body>
    <center>
        ...
        $query="SELECT * FROM s_r_data ORDER BY id DESC LIMIT 1";
        ...
        $sql = "INSERT INTO s_r_data  VALUES ('$first_name', 
            '$last_name','$father_name','$mother_name','$address','$sex','$city','$course','$country','$state','$district','$pincode','$email','$dob','$mobile','$id')";
